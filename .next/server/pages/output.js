...
class Output extends react__WEBPACK_IMPORTED_MODULE_2__.Component {
    ...
    static async getInitialProps(props) {
        ...
        let check = await fetch(`${_utils_domain__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z}/api/output/`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
var __webpack_exports__ = __webpack_require__.X(0, [152,159,675,619,19,196,212], () => (__webpack_exec__(7601)));
